...
public class SavantDatabaseHandler extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		/*db.execSQL(TABLE_CREATE_SITE_SUGGESTION);
		db.execSQL(TABLE_CREATE_SITE_EXPOSURE_SCORE);
		db.execSQL(TABLE_CREATE_SURVEY_ITEM_ADAPTIVE_CAPACITY);
		db.execSQL(TABLE_CREATE_SURVEY_ITEM_EXPOSURE);
		db.execSQL(TABLE_CREATE_SURVEY_ITEM_SENSITIVITY);*/
	}
